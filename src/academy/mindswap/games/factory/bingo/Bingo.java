...
package academy.mindswap.games.factory.bingo;
...
/**
 * Bingo is a game type and a subclass of the class game
...
public class Bingo extends Game {
     ...
     */
    public Bingo(Server server){
        super(server, GameType.BINGO);
    }
